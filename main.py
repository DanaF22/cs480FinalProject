...
from db import (get_connection, managerRegister, clientRegister, 
                clientLogin, updateClientInfo, viewAllBookings, 
                submitReview,printAvailableRooms,bookSpecificRoom,automaticBooking)
import manager_menu
